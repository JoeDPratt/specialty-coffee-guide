    ...
    return (
        <div className={`${className} w-auto`}>
            ...
            <div className="text-center text-pr-800 flex flex-col gap-1 items-center mt-1.5 mb-2.5">
                ...
                />
                <div className="font-sofia-sans-condensed leading-4 tracking-wide font-medium text-base mt-0 -mb-0.25">CUP SCORE</div>
                <hr className="h-0.25 text-pr-800 bg-pr-800 color-pr-800 border-none w-1/3"></hr>
                <div className="font-sofia-sans-condensed text-4xl font-black leading-8 mt-0.25">{score}</div>
            </div>
